...
import { LASDetails } from '@/components/forms/GoldLoanForm/lasDetails';
...
const form = useForm({
  ...
  defaultValues: {
    ...
    loanAmount: 0,
    tenor: 0,
    purposeOfLoan: 'Agri Allied Activity',
    securitiesBeingPledged: {
        shares: undefined,
        mfUnits: undefined,
        bonds: undefined,
        insurancePolicy: undefined,
        eGoldSilver: undefined,
        others: undefined,
  ...
  >
    ...
    {currentStep === 1 && <LASDetails control={form.control} />}
